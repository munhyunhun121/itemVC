...
class saveViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        // 버튼 아울렛하고 잘 연결시켜줘야됨 이것만 선언해주면 코너레디우스 잘 됨
        ...
        if let savedCustomers = UserDefaults.standard.array(forKey: "gonggongCustomersKey") as? [[String: String]] {
    ...
    func updateCountLabel() {
        countLabel.text = "124번코드 : \(customers.count)"
    }
    ...
    func saveCustomersToUserDefaults() {
       ...
       // for customer in customers: customers 배열을 순회하며 각각의 customer를 가져옵니다. customer는 Customer 타입의 객체입니다.
        ...
        UserDefaults.standard.set(serializedCustomers, forKey: "gonggongCustomersKey")
